package com.fantingame.game.msgbody.notify.friend;
...
import com.fantingame.game.msgbody.client.friend.UserChatRecordBO;

/**聊天信息推送**/
public class Friend_pushChatInfoNotify implements ICodeAble {
