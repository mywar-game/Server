...
public class NewDangleServiceImpl extends BasePartnerService {

	private static final Logger logger = Logger.getLogger(NewDangleServiceImpl.class);
	@Autowired
	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (NewDangleSdk.instance().verifySession(session, uid)) {
	...
	public boolean doPayment(PaymentObj paymentObj) {
		...
		if (!NewDangleSdk.instance().checkPayCallbackSign(cb)) {
