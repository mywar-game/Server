...
public class YXCQBaiduSdk extends BaseSdk {
	private static final Logger logger = Logger.getLogger(YXCQBaiduSdk.class);
	private static YXCQBaiduSdk ins;
	...
	public static YXCQBaiduSdk instance() {
		synchronized (YXCQBaiduSdk.class) {
			if (ins == null) {
				ins = new YXCQBaiduSdk();
			}
		}
