...
public class YXCQXiaomiServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(YXCQXiaomiServiceImpl.class);
	@Autowired
	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (YXCQXiaomiSdk.instance().verifySession(session, uid)) {
...
//		}
	...
	public PartenerEnum getPatenerEnum() {
		return PartenerEnum.YXCQ_XiaoMi;
	}
}
