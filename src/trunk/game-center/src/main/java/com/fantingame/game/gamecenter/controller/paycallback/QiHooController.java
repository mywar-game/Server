...
import com.fantingame.game.gamecenter.partener.qihoo.PayCallbackObject;
...
public class QiHooController {
	...
	@RequestMapping(value = "/webApi/qhPayment.do", method ={RequestMethod.POST,RequestMethod.GET})
	public ModelAndView qihooCallBack(HttpServletRequest req, HttpServletResponse res) {
		PartnerService ps = serviceFactory.getBean(PartenerEnum.QiHoo.getPartenerId());
