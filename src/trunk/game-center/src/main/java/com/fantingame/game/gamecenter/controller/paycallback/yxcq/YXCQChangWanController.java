...
@Controller
public class YXCQChangWanController {
	private static Logger LOG = Logger.getLogger(YXCQChangWanController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/yxcqcwPayment.do", method = RequestMethod.GET)
