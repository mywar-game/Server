...
public class AppChinaServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(AppChinaServiceImpl.class);
	@Autowired
	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (AppChinaSdk.instance().verifySession(session, uid)) {
	...
	public boolean doPayment(PaymentObj paymentObj) {
		...
		if (!AppChinaSdk.instance().checkPayCallbackSign(cb)) {
