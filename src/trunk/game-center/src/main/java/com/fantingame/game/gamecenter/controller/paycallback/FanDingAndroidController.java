...
@Controller
public class FanDingAndroidController {
	private static Logger LOG = Logger.getLogger(FanDingAndroidController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;
	@RequestMapping(value = "/webApi/ftAdroidPayment.do")
	public ModelAndView payCallback(HttpServletRequest req, HttpServletResponse res) {
		...
		String partnerId = PartenerEnum.FanTin.getPartenerId()+"";
