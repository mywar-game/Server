...
@Controller
public class YueNanController {
	private static final Logger LOG = Logger.getLogger(YueNanController.class);
	...
	@RequestMapping(value = "/webApi/yueNanPayment.do")
	public ModelAndView payCallback(HttpServletRequest req, HttpServletResponse res) {
		PartnerService ps = serviceFactory.getBean(PartenerEnum.YUENANANDR.getPartenerId());
		try {
...
//			String aa = "{\"amount\":\"10000\",\"cardCode\":\"18544797753573\",\"cardSerial\":\"BIT226802\",\"cardVendor\":\"VINAPHONE\",\"countryCode\":\"VN\",\"currency\":\"VND\",\"hash\":\"8310b2ebe66e3226351b793e178ee358\",\"sandbox\":\"0\",\"state\":\"0160012014051400000050\",\"status\":\"1\",\"target\":\"username:foryou5421|userid:1388148\",\"transactionId\":\"36537311A5186D8\",\"transactionType\":\"CARD\"}";
