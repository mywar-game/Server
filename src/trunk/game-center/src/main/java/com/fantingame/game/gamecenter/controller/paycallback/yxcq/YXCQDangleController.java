...
import com.fantingame.game.gamecenter.partener.yxcq.dangle.DanglePaymentObj;
import com.fantingame.game.gamecenter.service.PartnerService;

@Controller
public class YXCQDangleController {
	private static Logger LOG = Logger.getLogger(YXCQDangleController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/yxcqdlPayment.do", method = RequestMethod.GET)
