...
@Controller
public class YXCQBaiduController {
	private static Logger LOG = Logger.getLogger(YXCQBaiduController.class);
	...
	@RequestMapping(value = "/webApi/yxcqbaiduPayment.do", method = RequestMethod.POST)
