...
public class YXCQDuoKuSdk extends BaseSdk {
	
	private static final Logger logger = Logger.getLogger(YXCQDuoKuSdk.class);
	
	private static YXCQDuoKuSdk ins;
	...
	public static YXCQDuoKuSdk instance() {
		synchronized (YXCQDuoKuSdk.class) {
			if (ins == null) {
				ins = new YXCQDuoKuSdk();
			}
		}
		return ins;
	}

	private YXCQDuoKuSdk() {
		loadSdkProperties();
	}
