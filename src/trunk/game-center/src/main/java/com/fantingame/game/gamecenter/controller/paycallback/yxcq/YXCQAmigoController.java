 ...
 */
@Controller
public class YXCQAmigoController {

	private static Logger LOG = Logger.getLogger(YXCQAmigoController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/yxcqamigoPayment.do", method = RequestMethod.POST)
