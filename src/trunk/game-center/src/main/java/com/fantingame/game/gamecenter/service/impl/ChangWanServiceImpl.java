...
public class ChangWanServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(ChangWanServiceImpl.class);
	@Autowired
	...
	public UserToken login(String token, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (ChangWanSdk.instance().verifySession(session, uid, ip, port, loginTimesamp)) {
	...
	public boolean doPayment(PaymentObj paymentObj) {
		...
		if (!ChangWanSdk.instance().checkPayCallbackSign(cb)) {
