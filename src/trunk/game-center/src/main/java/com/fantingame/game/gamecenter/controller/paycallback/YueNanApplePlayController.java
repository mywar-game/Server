...
@Controller
public class YueNanApplePlayController {
	private static final Logger LOG = Logger.getLogger(YueNanApplePlayController.class);
	...
	@RequestMapping(value = "/webApi/yueNanApplePayment.do")
