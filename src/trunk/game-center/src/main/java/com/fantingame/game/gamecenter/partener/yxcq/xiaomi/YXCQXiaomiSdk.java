...
public class YXCQXiaomiSdk extends BaseSdk {
	
	private static final Logger logger = Logger.getLogger(YXCQXiaomiSdk.class);
	
	private static YXCQXiaomiSdk ins;
	...
	public static YXCQXiaomiSdk instance() {
		synchronized (YXCQXiaomiSdk.class) {
			if (ins == null) {
				ins = new YXCQXiaomiSdk();
			}
		}
