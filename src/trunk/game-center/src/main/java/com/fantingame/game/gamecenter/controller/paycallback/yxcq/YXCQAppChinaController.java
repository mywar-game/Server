...
@Controller
public class YXCQAppChinaController {
	private static Logger LOG = Logger.getLogger(YXCQAppChinaController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/yxcqappChinaPayment.do")
