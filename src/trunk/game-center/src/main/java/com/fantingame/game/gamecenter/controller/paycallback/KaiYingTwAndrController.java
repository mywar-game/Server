...
@Controller
public class KaiYingTwAndrController {
	private static Logger LOG = Logger.getLogger(KaiYingTwAndrController.class);
	
	@Autowired
	private PartnerServiceFactory serviceFactory;

	@RequestMapping(value = "/webApi/kaiYingTwAndrPayment.do", method = RequestMethod.POST)
