 ...
 * @author yezp
 */
public class AmigoSdk extends BaseSdk {

	private static final Logger logger = Logger.getLogger(AmigoSdk.class);
	private static AmigoSdk ins;
	...
	public static AmigoSdk instance() {
		synchronized (AmigoSdk.class) {
			if (ins == null) {
				ins = new AmigoSdk();
			}
		}
