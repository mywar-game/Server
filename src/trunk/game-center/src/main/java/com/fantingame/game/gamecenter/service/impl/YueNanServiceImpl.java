...
public class YueNanServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(YueNanServiceImpl.class);
	...
	public PartenerEnum getPatenerEnum() {
		return PartenerEnum.YUENANINGAME;
	}
