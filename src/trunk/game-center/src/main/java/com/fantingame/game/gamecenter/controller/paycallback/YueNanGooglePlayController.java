...
@Controller
public class YueNanGooglePlayController {
	private static final Logger LOG = Logger.getLogger(YueNanGooglePlayController.class);
	...
	@RequestMapping(value = "/webApi/yueNanGooglePayment.do")
	public ModelAndView payCallback(HttpServletRequest req, HttpServletResponse res) {
		...
		try {
			...
			}else if("APPLE_ITUNES".equals(data.getTransactionType())){
				data.setProductId(req.getParameter("productid"));
			}
