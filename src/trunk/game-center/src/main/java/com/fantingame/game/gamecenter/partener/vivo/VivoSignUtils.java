...
public class VivoSignUtils {
	...
	private static final Logger logger = Logger.getLogger(VivoSignUtils.class);
	// vivo分配的商户私钥
	...
	public static boolean verifySignature(Map<String, String> para, String key) {
		...
		logger.info("服务器签名：" + signature + " | 请求消息中的签名："
				+ respSignature);
		// 对比签名值
	...
	public static void main(String[] args) {
		...
		para.put("notifyUrl",
				"http://127.0.0.1:8080/vivopay/vivoPay/testNotify");
