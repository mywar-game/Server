...
import com.fantingame.game.gamecenter.partener.yxcq.huawei.HuaWeiPaymentObj;
import com.fantingame.game.gamecenter.partener.yxcq.huawei.YXCQHuaWeiSdk;
import com.fantingame.game.gamecenter.partener.yxcq.huawei.HwUserInfo;
 ...
 * @author yezp
 */
public class YXCQHuaWeiServiceImpl extends BasePartnerService {
	
	private static final Logger logger = Logger.getLogger(YXCQHuaWeiServiceImpl.class);
	@Autowired
	...
	public UserToken login(String token, String partnerId, String serverId,
		...
		try {
			...
			HwUserInfo userInfo = YXCQHuaWeiSdk.instance().getUid(token, timestamp);			
			if (userInfo != null) {
	...
	public String createOrder(String partnerId, String serverId,
		...
		TradeInfo info = createOrderInfo(partnerId, serverId, partnerUserId,
				amount, tradeName);
//		info.setNotifyUrl("http://wapi.andr.hw.fantingame.com:80/webApi/yxcqhuaWeiPayment.do");
		info.setNotifyUrl("http://203.195.190.121:8089/webApi/yxcqhuaWeiPayment.do");
...
//		info.setNotifyUrl("http://wapi.andr.hw.fantingame.com:80/webApi/yxcqhuaWeiPayment.do");
	...
	public PartenerEnum getPatenerEnum() {
		return PartenerEnum.YXCQ_huaWei;
	}
}
