package com.fantingame.game.gamecenter.partener.yxcq.qihoo;
 ...
 *
 */
public class YXCQQiHooSdk extends BaseSdk {
	private final static Logger logger = Logger.getLogger(YXCQQiHooSdk.class);
	
	private static YXCQQiHooSdk ins;
	...
	public static YXCQQiHooSdk instance(){
		synchronized (YXCQQiHooSdk.class) {
			if(ins == null){
				ins = new YXCQQiHooSdk();
			}
		}
