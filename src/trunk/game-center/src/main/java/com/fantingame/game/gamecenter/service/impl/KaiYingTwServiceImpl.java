...
public class KaiYingTwServiceImpl extends BasePartnerService {

	private static final Logger logger = Logger.getLogger(KaiYingTwServiceImpl.class);
	@Autowired
