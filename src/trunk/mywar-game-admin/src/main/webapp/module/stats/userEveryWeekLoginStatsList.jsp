		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="22" align="center">
					<center>
						<s:text name="userEveryWeekLoginStatsListJsp.title"></s:text>
					</center>
				</td>
			</tr>
			<tr>
				<td>
					<s:text name="userEveryWeekLoginStats.date"></s:text>
				</td>
				<td>
					<s:text name="userEveryWeekLoginStats.totalTimes"></s:text>
				</td>
				<td>
					<s:text name="userEveryWeekLoginStats.userNumber"></s:text>
				</td>
				<td>
					<s:text name="userEveryWeekLoginStats.ipNumber"></s:text>
				</td>
			</tr>
