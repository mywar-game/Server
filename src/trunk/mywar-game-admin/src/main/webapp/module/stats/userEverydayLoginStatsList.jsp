...
<html>
	...
	<body>
		<form action="userEverydayLoginStatsList" method="post" onsubmit="return check()">
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="22" align="center">
					<center>
						<s:text name="userEverydayLoginStatsListJsp.title"></s:text>
					</center>
				</td>
			</tr>
			<tr>
				<td>
					<s:text name="userEverydayLoginStats.date"></s:text>
				</td>
				<td>
					<s:text name="userEverydayLoginStats.totalTimes"></s:text>
				</td>
				<td>
					<s:text name="userEverydayLoginStats.userNumber"></s:text>
				</td>
				<td>
					<s:text name="userEverydayLoginStats.ipNumber"></s:text>
				</td>
			</tr>
