...
<html>
	<head>
		<title><s:text name="userActiveStatsListJsp.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<body>
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="22" align="center">
					<center>
						<s:text name="userActiveStatsListJsp.title"></s:text>
					</center>
				</td>
			</tr>
			<tr>
				<td>
					<s:text name="userActiveStats.date"></s:text>
				</td>
				<td>
					<s:text name="userActiveStats.activeUserAmount"></s:text>
				</td>
				<td>
					<s:text name="userActiveStats.regAmount"></s:text>
				</td>
				<td>
					<s:text name="userActiveStats.stats1"></s:text>
				</td>
			</tr>
			<s:iterator var="stats" value="statsList">
				<tr>
					...
					<td>
						${stats.activeUserAmount}
					</td>
					<td>
						${stats.regAmount}
					</td>
					<td>
						<fmt:formatNumber type="percent" value="${stats.activeUserAmount/stats.regAmount}" pattern=".#%" />
					</td>
				</tr>
			</s:iterator>
		...
		<s:generator separator="," val="%{getText('userActiveStatsListJsp.note_value')}">
			<s:iterator var="str">
				<s:text name="%{'userActiveStatsListJsp.note'+#str}"></s:text><br>
			</s:iterator>
		</s:generator>
	</body>
</html>