...
<html>
	<head>
		<title><s:text name="mallStatsListJsp.title"></s:text></title>
	...
	<body>
		<div>
			<form action="mallStatsList" method="post">
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="mallStatsListJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="22">
						<aldtags:pageTag paraStr="channel,${channel},sysNum,${sysNum},order,${order}"/>
					</td>
				</tr>
			</table>
			<div style=”color:red”> 
