...
<html>
	<head>
		<title><s:text name="userCreateRoleLossStatsListJsp.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<body>
		<div>
			<form action="userCreateRoleLossStatsList" method="post" onsubmit="return check()">
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="userCreateRoleLossStatsListJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
					<td>
						<s:text name="userCreateRoleLossStatsList.date"></s:text>
					</td>
					<td>
						<s:text name="userCreateRoleLossStatsList.regAmount"></s:text>
					</td>
					<td>
						<s:text name="userCreateRoleLossStatsList.createAmount"></s:text>
					</td>
				</tr>
			...
			<s:text name="userCreateRoleLossStatsListJsp.note"></s:text><br>
			<s:generator separator="," val="%{getText('userCreateRoleLossStatsListJsp.note_value')}">
				<s:iterator var="str">
					<s:text name="%{'userCreateRoleLossStatsListJsp.note'+#str}"></s:text><br>
				</s:iterator>
			</s:generator>
		</div>
	</body>
