...
<html>
	<head>
		<title><s:text name="userPayStatsListJsp.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<body>
		<div>
			<form action="userPayStatsList" method="post" onsubmit="return check()">
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="userPayStatsListJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
					<td>
						<s:text name="userPayStats.date"></s:text>
					</td>
					<td>
						<s:text name="userPayStats.payAmount"></s:text>
					</td>
				</tr>
