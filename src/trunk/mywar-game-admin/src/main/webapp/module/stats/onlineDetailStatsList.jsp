...
<html>
	<head>
		<title><s:text name="onlineDetailStatsListJsp.title"></s:text></title>
	...
	<body>
		<div>
			<form action="onlineDetailStatsList" method="post" onsubmit="return check1()">
				<s:text name="searchPartner"></s:text><s:text name="colon"></s:text>
				<s:select name="pid" id="pid" list="partnerList" listKey="pid" listValue="PName" headerKey="0" headerValue="%{getText('pleaseSelect')}"/>
				<s:text name="searchServer"></s:text><s:text name="colon"></s:text>
				<s:select name="serverId" id="serverId" list="serverMap" headerKey="0" headerValue="%{getText('pleaseSelect')}"/>
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="onlineDetailStatsListJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
					<td>
						<s:text name="onlineDetailStats.server"></s:text>
					</td>
					<td>
				...
				<tr>
					<td colspan="22">
						<aldtags:pageTag paraStr="pid,${pid},serverId,${serverId},pageSize,${pageSize}"  datePara1="startDate" dateValue1="${startDate}"/>
					</td>
				</tr>
			</table>
			<div style=”color:red”> 
