...
<html>
	<head>
		<title><s:text name="registerStatsAoHistoryListJsp.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<script type="text/javascript">
		function findLevelAnalyze(sysNum) {
			window.location.href = "levelStatsAoList?sysNum=" + sysNum;
		}
	</script>
	<body>
		<form action="registerStatsAoHistoryList?isCommit=T" method="post" onsubmit="return check()">
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="22" align="center">
					<center>
						<s:text name="registerStatsAoHistoryListJsp.title"></s:text>
					</center>
				</td>
			</tr>
			<tr>
