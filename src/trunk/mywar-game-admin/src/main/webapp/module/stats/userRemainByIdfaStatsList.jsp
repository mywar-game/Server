...
<html>
	...
	<body>
		<form action="userRemainStatsByIdfaList" method="post" onsubmit="return check()">
		...
		<br>
		<br>
		<s:text name="userRemainByIdfaStatsListJsp.note"></s:text><br>
		<s:generator separator="," val="%{getText('userRemainByIdfaStatsListJsp.note_value')}">
			<s:iterator var="str">
				<s:text name="%{'userRemainByIdfaStatsListJsp.note'+#str}"></s:text><br>
			</s:iterator>
		</s:generator>
	</body>
</html>