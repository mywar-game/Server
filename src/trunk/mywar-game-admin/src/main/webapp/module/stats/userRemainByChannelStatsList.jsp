...
<html>
	<head>
		...
		<script>
			function changeSelectChannel(obj) {
				var startDate = document.getElementById("startDate").value;
				var endDate = document.getElementById("endDate").value;
				window.location.href="userRemainStatsByChannel?channel="+obj.value+"&startDate="+startDate+"&endDate="+endDate;
			}	
		</script>
	</head>
	...
	<body>
		<form action="userRemainStatsByChannel" method="post" onsubmit="return check()">
			...
			<s:select name="channel" id="pid" list="partnerList" listKey="pid" listValue="PName" headerKey="0" headerValue="%{getText('pleaseSelect')}" onchange="changeSelectChannel(this);"/>
			<input type="submit" value="<s:text name='submit'></s:text>" class="button" />
		</form>
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="36" align="center">
					<center>
						留存统计
					</center>
				</td>
			...
			<tr>
				<td colspan="36">
					<aldtags:pageTag paraStr="channel,${channel}" datePara1="startDate" dateValue1="${startDate}" datePara2="endDate" dateValue2="${endDate}" para1="pageSize" value1="${pageSize}"/>
				</td>
			</tr>
		</table>
		<br>
		<br>
		<s:text name="userRemainByChannelStatsListJsp.note"></s:text><br>
		<s:generator separator="," val="%{getText('userRemainByChannelStatsListJsp.note_value')}">
			<s:iterator var="str">
				<s:text name="%{'userRemainByChannelStatsListJsp.note'+#str}"></s:text><br>
			</s:iterator>
		</s:generator>
	</body>
</html>