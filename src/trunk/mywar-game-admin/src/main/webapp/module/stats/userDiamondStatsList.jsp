	...
	<head>
		...
		<script>
			function changeSelect(obj) {
				...
				if (sType == "T") {
					var sName = 1;
					window.location.href="userDiamondStatsList?isCommit=T";
				} else if (sType == "F") {
					var sName = 2;
					window.location.href="userDiamondStatsList?isCommit=F";
				}
			}
		</script>
	</head>
	<body>
		<form action="userDiamondStatsList" method="post" onsubmit="return check()">
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="61" align="center">
					<center>
						<s:text name="userDiamondStatsListJsp.title"></s:text>
						<s:text name="userDiamondStatsListJsp.tips"></s:text>
					</center>
				</td>
			</tr>
			<tr>
				<td>
					<s:text name="userDiamondStats.date"></s:text>
				</td>
				<td>
					<s:text name="userDiamondStats.server"></s:text>
				</td>
				<td>
			...
			<s:iterator var="stats" value="statsList">
				<tr>
					...
					<td>
						<fmt:formatNumber type="number" value="${stats.leftDiamond}" pattern="#,###" />
						<!-- 剩余钻石 -->
					</td>
					<td>
						<fmt:formatNumber type="number" value="${stats.actityDiamond}" pattern="#,###" />
					</td>
				</tr>
			</s:iterator>
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			...
			<tr>
				...
				<!-- begin 获得 -->
					...
					<td>
						<fmt:formatNumber type="number" value="${stats.activityDiamond}" pattern="#,###" />
					</td>
					<!-- end 获得 -->
			</tr>
			</s:iterator>
