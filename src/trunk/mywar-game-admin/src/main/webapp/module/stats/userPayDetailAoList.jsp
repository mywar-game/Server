...
<html>
	<head>
		<title><s:text name="userPayDetailAoList.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<body>
		<div>
			<form action="userPayDetailAoList" method="post" onsubmit="return beforeSubmit(),check()">
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="userPayDetailAoList.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
