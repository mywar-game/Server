...
<html>
	<head>
		<title><s:text name="loginStatsAoListJsp.title"></s:text></title>
		<style type="text/css">
		td {
			text-align: center;
		}
	...
	<body>
		<form action="loginStatsAoList?isCommit=T" method="post" onsubmit="return check1()">
		...
		<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
			<tr class="border">
				<td class="td_title" colspan="22" align="center">
					<center>
						<s:text name="loginStatsAoListJsp.title"></s:text>
					</center>
				</td>
			</tr>
			<tr>
