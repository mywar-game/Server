...
<html>
	<head>
		<title><s:text name="levelStatsListJsp.title"></s:text></title>
	...
	<body>
		<div>
			<form action="levelStatsList" method="post">
			...
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="22" align="center">
						<center>
							<s:text name="levelStatsListJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="22">
						<aldtags:pageTag paraStr="channel,${channel},sysNum,${sysNum},order,${order}" datePara1="startDate" dateValue1="${startDate}"/>
					</td>
				</tr>
			</table>
			<div style=”color:red”> 
