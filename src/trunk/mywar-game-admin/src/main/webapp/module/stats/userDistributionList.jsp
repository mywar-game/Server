	...
	<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
		<tr class="border">
			<td class="td_title" colspan="22" align="center">
				<center>
					<s:text name="userDistributionList.title"></s:text>
				</center>
			</td>
		</tr>
		<tr>
			<td>
				<s:text name="userDistributionList.id"></s:text>
			</td>
			<td>
				<s:text name="userDistributionList.name"></s:text>
			</td>
			<td>
				<s:text name="userDistributionList.num"></s:text>
			</td>
			<td>
				<s:text name="userDistributionList.percent"></s:text>
			</td>
		</tr>
		<s:iterator var="stats" value="userDistributionList">
			<tr>
				<td>
					${stats.mainHeroId}
				</td>
