...
<html>
	<head>
		...
		<title><s:text name="drawGoods.update"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateDrawGoods?isCommit=T" method="post">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="drawGoods.update"></s:text>
				...
				<tr>
					<td>
						<input type="hidden" id="goodsId" name="goodsId" value="${drawGoods.goodsId}"/>
						<input type="hidden" id="activityId" name="activityId" value="${drawGoods.activityId}"/>
						<s:text name="drawGoods.pos"></s:text><s:text name="colon"></s:text>
					</td>
					<td>
						<input type="text" name="pos" value="${drawGoods.pos}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						...
						<input type="text" id="toolTypeName" readonly="readonly" name="toolTypeName" value="${drawGoods.toolTypeName}"/>
				...
				<tr>
					...
					<td>
						...
						<input type="text" size="40" readonly="readonly" id="toolName" name="toolName" value="${drawGoods.toolName}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="toolNum" name="toolNum" value="${drawGoods.toolNum}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="refreshLowerNum" name="refreshLowerNum" value="${drawGoods.refreshLowerNum}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<input type="text" id="refreshUpperNum" name="refreshUpperNum" value="${drawGoods.refreshUpperNum}"/>
					</td>
				</tr>
				<tr>
