...
<html>
	<head>
		...
		<title><s:text name="updateAdminPkAwardJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateAdminPkAward?isCommit=T" method="post">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="updateAdminPkAwardJsp.title"></s:text>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="score" name="score" value="${adminPkAward.score}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="tools" name="tools" value="${adminPkAward.tools}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="name" name="name" value="${adminPkAward.name}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="4">
						<textarea size="45" name="description" rows="4" cols="60" value=""/>${adminPkAward.description}</textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="imgId" name="imgId" value="${adminPkAward.imgId}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="day_buy_num" name="day_buy_num" value="${adminPkAward.day_buy_num}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="4">
						<input type="text" id="total_buy_num" name="total_buy_num" value="${adminPkAward.total_buy_num}"/>
					</td>
				</tr>				
