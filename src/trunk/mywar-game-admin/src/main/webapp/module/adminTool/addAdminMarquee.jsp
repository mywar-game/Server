...
<html>
	...
	<body>
		&nbsp;
		<form action="addAdminMarquee?isCommit=T" method="post">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="addAdminMarqueeJsp.title"></s:text>
				...
				<tr>
					...
					<td colspan="4">
						<textarea size="45" name="content" rows="4" cols="60" value="" /></textarea>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td colspan="4">
						<input type="text" id="playInterval" name="playInterval" value=""/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="4">
						<input type="text" id="loopTime" name="loopTime" value=""/>
					</td>
				</tr>
				<tr>
					<td>
				...
				%>
						...
						%>
								<td><input type="checkbox" value="<%=gameWeb.getServerId()%>_<%=server.getServerId()%>" id="<%=gameWeb.getServerId()%>_<%=server.getServerId()%>" name="serverIdArr" /><%=server.getServerAlias()%></td>
								<%if (size % 5 == 0) {%>
									</tr>
								<%}%>
						<%	}
				...
				<tr>
					...
					<td colspan="4">
						...
						<select name="partnerIds" class="select">
							<option value="0"><s:text name="AdminMarquee.allPartner"></s:text>
