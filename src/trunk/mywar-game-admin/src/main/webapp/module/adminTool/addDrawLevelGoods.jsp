...
<html>
	<head>
		...
		<title><s:text name="drawLevel.add"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="addDrawLevelGoods?isCommit=T" method="post">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="drawLevel.add"></s:text>
				...
				<tr>
					...
					<td>
						<input type="text" name="level" value="${levelGoods.level}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="replacePos" value="${levelGoods.replacePos}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="hidden" id="toolType" name="toolType" value="${levelGoods.toolType}"/>
				...
				<tr>
					...
					<td>
						<input type="hidden" id="toolId" name="toolId" value="${levelGoods.toolId}"/>
				...
				<tr>
					...
					<td>
						<input type="text" id="toolNum" name="toolNum" value="${levelGoods.toolNum}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="refreshLowerNum" name="refreshLowerNum" value="${levelGoods.refreshLowerNum}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
					<input type="text" id="refreshUpperNum" name="refreshUpperNum" value="${levelGoods.refreshUpperNum}"/>
					</td>
				</tr>
				<tr>
