...
<html>
	...
	<s:iterator id="QN" value="partnerQnList" status="sta">
		...
		function downloadExcel() {
				...
				ajaxobj.url = "allServerInfoListNew?isExportFlag=1&qn="+ qn +"&channel="+ channel +"&sysNum="+sysNum + "&startDate=" + startDate + "&endDate=" + endDate;
	...
	<body>
		<div>
		<form id="form1" action="allServerInfoListNew" method="post" onsubmit="return check()">
