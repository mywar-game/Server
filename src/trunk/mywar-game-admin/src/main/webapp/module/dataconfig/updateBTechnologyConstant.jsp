...
<html>
	<head>
		...
		<title><s:text name="updateBTechnologyConstantJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateBTechnologyConstant?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<s:text name="updateBTechnologyConstantJsp.title"></s:text> &nbsp;
				...
				<tr>
					...
					<td>
						<input type="text" name="level" value="${technologyConstant.level}" class="maxLife" size="10" maxlength="11" onblur="value=value.replace(/[^\d]/g,'')" />
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input type="text" name="value" value="${technologyConstant.value}" class="maxLife" size="4" maxlength="4" />
					</td>
				</tr>
				<tr>
					<td>
