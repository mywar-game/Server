...
<html>
	<head>
		...
		<title><s:text name="addBBuildingConstantJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="addBBuildingConstant?isCommit=T" method="post">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<s:text name="addBBuildingConstantJsp.title"></s:text>&nbsp;
				...
				<tr>
					...
					<td>
						<input type="text" name="buildingName" value="${buildingConstant.buildingName}" class="maxLife" size="50" maxlength="50"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="buildingDesc" value="${buildingConstant.buildingDesc}" class="maxLife" size="150" maxlength="200"/>
					</td>
				</tr>
				<tr>
					<td>
						<s:text name="buildingConstant.maxLevel"></s:text><s:text name="colon"></s:text><s:text name="buildingConstant.displayLevel"></s:text><s:text name="colon"></s:text>
					</td>
					<td>
