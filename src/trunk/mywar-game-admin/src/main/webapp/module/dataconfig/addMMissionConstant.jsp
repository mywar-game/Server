...
<html>
	<head>
		...
		<title><s:text name="addMMissionConstantJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body onload="setNextIdTrStyle()">
		...
		<form action="addMMissionConstant?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table id="table" cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="6">
						<s:text name="addMMissionConstantJsp.title"></s:text> &nbsp;
				...
				<tr>
					...
					<td colspan="5">
						<input type="text" name="missionId" value="${mmissionConstant.missionId}" class="maxLife" size="10" maxlength="11" />
					</td>
				</tr>
				<tr>				
					<td>
					...
					<tr>
						...
						<td>
						    ...
						    <s:if test="#condition.targetType == 1 || #condition.targetType == 4">
						     	...
						     	<input name="missionCondition.targetNum" value="${condition.targetNum}" readonly="readonly" size="4"/>
							</s:if>
							<s:elseif test="#condition.targetType == 2 || #condition.targetType > 200">
								...
								<input name="missionCondition.targetNum" value="${condition.targetNum}" readonly="readonly"/>
							</s:elseif>
