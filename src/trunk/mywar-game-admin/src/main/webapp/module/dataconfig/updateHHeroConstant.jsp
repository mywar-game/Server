...
<html>
	<head>
		<title><s:text name="updateHHeroConstantJsp.title"></s:text>
		</title>
	</head>
	...
	<body>
		...
		<form action="updateHHeroConstant?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="4">
						<s:text name="updateHHeroConstantJsp.title"></s:text>&nbsp;
