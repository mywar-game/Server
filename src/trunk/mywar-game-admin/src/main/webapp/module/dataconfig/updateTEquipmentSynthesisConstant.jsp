...
<html>
	<head>
		<title><s:text name="updateTEquipmentSynthesisConstantJsp.title"></s:text></title>
	...
	<body>
	<form action="updateTEquipmentSynthesisConstant?isCommit=T" method="post" onsubmit="return beforeSubmit()">
		<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="7" align="center">
						<center><s:text name="updateTEquipmentSynthesisConstantJsp.title"></s:text> &nbsp;</center>
				...
				<tr id="${tequipmentSynthesisConstant.equipmentId}">
					<td>
						<s:text name="equipmentSynthesisConstant.equipmentId"></s:text><s:text name="colon"></s:text>
					</td>
					<td>
						<input type="text" name="equipmentId" value="${tequipmentSynthesisConstant.equipmentId}" class="maxLife" size="10" maxlength="11" readonly />
					...
					<td>
						${tequipmentSynthesisConstant.equipmentName}
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="num" value="${num1}" class="maxLife" size="20" maxlength="20" onblur="value=value.replace(/[^\d]/g,'')" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="num" value="${num2}" class="maxLife" size="20" maxlength="20" onblur="value=value.replace(/[^\d]/g,'')" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="num" value="${num3}" class="maxLife" size="20" maxlength="20" onblur="value=value.replace(/[^\d]/g,'')" />
					</td>
				</tr>
