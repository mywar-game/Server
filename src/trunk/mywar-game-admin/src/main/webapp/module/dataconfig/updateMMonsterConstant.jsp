...
<html>
	<head>
		...
		<title><s:text name="updateMMonsterConstantJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateMMonsterConstant?isCommit=T" method="post" onsubmit="return isSubmit()">

			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5" align="center">
						<center><s:text name="updateMMonsterConstantJsp.title"></s:text> &nbsp;</center>
				...
				<tr>
					...
					<td>
						<input type="text" name="monsterId" value="${monsterConstant.monsterId}" class="maxLife" size="10" maxlength="11" readonly="readonly"/>
