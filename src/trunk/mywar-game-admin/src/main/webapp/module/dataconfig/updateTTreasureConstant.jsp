...
<html>
	<head>
		...
		<title><s:text name="updateTTreasureConstantJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateTTreasureConstant?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<s:text name="updateTTreasureConstantJsp.title"></s:text> &nbsp;
				...
				<tr>
					<td>
						<s:text name="treasureConstant.pathWay"></s:text><s:text name="colon"></s:text>
					</td>
					<td colspan="3">
						<s:generator separator="," val="%{getText('treasureConstant.pathWay_value')}">
							<s:iterator var="str">
								...
								<input type="checkbox" name="pathWay" value="${str}" <s:if test="isCheck">checked="checked"</s:if>/><s:text name="%{'treasureConstant.pathWay_'+#str}"></s:text><br/>
							</s:iterator>
						</s:generator>	
					</td>
				</tr>
