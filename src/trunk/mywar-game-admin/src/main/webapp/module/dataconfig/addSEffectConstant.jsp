...
<html>
 <head>
	...
	<body>
    	<form action="addSEffectConstant?isCommit=T" method="post">
    		<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
    			<tr class="border">
					<td class="td_title" colspan="4">
						<center>技能效果常量添加 &nbsp;</center>
				...
				<tr>
					...
					<td>
						<input type="radio" name="useFormula" id="useFormula1" value="1" checked="checked" /><label for="useFormula1">用</label>
						<input type="radio" name="useFormula" id="useFormula2" value="2"  /><label for="useFormula2">不用</label>
					</td>
					<td>
						数值类型
					</td>
