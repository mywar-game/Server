...
<html>
	<head>
		...
		<title><s:text name="updateBDummy.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form action="updateBDummy?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<s:text name="updateBDummy.title"></s:text> &nbsp;
				...
				<tr>
					...
					<td>
						<input type="text" name="dummyName" value="${dummy.dummyName}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="dummyDuration" value="${dummy.dummyDuration}" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="buyPrice" value="${dummy.buyPrice}" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="factor1" value="${dummy.factor1}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="factor2" value="${dummy.factor2}" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="moneyFactor1" value="${dummy.moneyFactor1}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="moneyFactor2" value="${dummy.moneyFactor2}" />
					</td>
				</tr>
