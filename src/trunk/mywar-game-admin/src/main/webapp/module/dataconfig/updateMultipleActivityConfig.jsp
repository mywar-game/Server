...
<html>
	...
	<body>
		&nbsp;
		<form action="updateMultipleActivityConfig?isCommit=T" method="post" onsubmit="return isSubmit()">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				...
				<tr>
					...
					<td>
						<input type="text" id="startDate" name="startDate" value="<s:if test="multipleActivityConfig.startDate != null"><s:text name="format.date_ymd"><s:param value="multipleActivityConfig.startDate"></s:param></s:text></s:if>" class="Wdate" style="width:100px" onfocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd',onpicked:function(){endDate.focus();}})"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="endDate" name="endDate" value="<s:if test="multipleActivityConfig.endDate != null"><s:text name="format.date_ymd"><s:param value="multipleActivityConfig.endDate"></s:param></s:text></s:if>" class="Wdate" style="width:100px" onfocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="startTime" name="startTime" value="<s:if test="multipleActivityConfig.startTime != null"><s:text name="format.date_hms"><s:param value="multipleActivityConfig.startTime"></s:param></s:text></s:if>" class="Wdate" style="width:100px" onfocus="WdatePicker({startDate:'00:00:00',dateFmt:'HH:mm:ss',onpicked:function(){endTime.focus();}})"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="endTime" name="endTime" value="<s:if test="multipleActivityConfig.endTime != null"><s:text name="format.date_hms"><s:param value="multipleActivityConfig.endTime"></s:param></s:text></s:if>" class="Wdate" style="width:100px" onfocus="WdatePicker({startDate:'00:00:00',dateFmt:'HH:mm:ss'})"/>
					</td>
				</tr>
				<tr>
					<td>
