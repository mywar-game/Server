...
<html>
  <head>
    <title><s:text name="addTMallTreasureConstantJsp.title"></s:text></title>
  ...
  <body>
   	<form action="addTMallTreasureConstant?isCommit=T" method="post">
	    <table id="table" cellpadding="3" cellspacing="1" border="0"
				width="100%" align=center>
	    	<tr class="border">
					<td class="td_title" colspan="20" align="center">
						<center>
							<s:text name="addTMallTreasureConstantJsp.title"></s:text>
						</center>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="id.treasureId"  class="maxLife" size="10" maxlength="11" onblur="value=value.replace(/[^\d]/g,'')" />
					</td>
					</tr>
				<tr>
					<td>
					...
					<td>
						<select name="id.category" class="select">
							<s:generator separator="," val="%{getText('mallTreasureConstant.id.category_value')}">
								<s:iterator var="str">
									<option value="${str}" <s:if test="tMallTreasureConstant.id.category == #str">selected=selected</s:if>>
										<s:text name="%{'mallTreasureConstant.id.category_'+#str}"></s:text>
									</option>
								</s:iterator>
							</s:generator>							
						</select>
				...
				<tr>
					...
					<td>
						<input type="text" name="originalPrice" value="${tmallTreasureConstant.originalPrice}" class="maxLife" size="10" maxlength="11" readonly" />
					</td>
					</tr>
				<tr>
					<td>
				...
				<tr>
					<td align="center" colspan="2">
						<input type="submit" value="<s:text name="submit"></s:text>" class="botton"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="reset" value="<s:text name="reset"></s:text>" class="botton"/>
					</td>	
				</tr> 
	    </table>
    </form>
