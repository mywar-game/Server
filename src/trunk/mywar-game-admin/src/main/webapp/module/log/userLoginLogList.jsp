...
<html>
	...
	<body>
		<form action="userLoginLogList?isCommit=T" method="post" onsubmit="return dateMust()">
			<table>
				<tr>
					<td>
		...
		<tr class="border">
			...
			<s:iterator var="userLoginLog" value="userLoginLogList" status="sta">
				<tr>
					<td>
						${sta.index+1}
					</td>
					...
					<td>
						<s:text name="format.date_time">
							<s:param value="#userLoginLog.loginTime"></s:param>
						</s:text>
					</td>
				</tr>
			</s:iterator>
