...
<html>
	<head>
		...
		<title><s:text name="addpysicsJsp.title"></s:text></title>
	...
	<body>
		<form action="addpysics?isCommit=T" method="post" onsubmit="return checkform();" name="pform">
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="3">
						<s:text name="addpysicsJsp.title"></s:text> &nbsp;
