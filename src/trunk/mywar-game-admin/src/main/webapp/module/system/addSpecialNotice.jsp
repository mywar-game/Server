...
<html>
	<head>
		...
		<title><s:text name="addSpecialNoticeJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form name="f" action="addSpecialNotice?isCommit=T" method="post" >
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="addSpecialNoticeJsp.title"></s:text>
