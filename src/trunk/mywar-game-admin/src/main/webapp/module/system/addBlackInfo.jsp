...
<html>
	<head>
		...
		<title><s:text name="addBlackInfoJsp.title"></s:text></title>
	</head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
		&nbsp;
		<form name="f" action="addBlackInfo?isCommit=T" method="post" >
			<table cellpadding="3" cellspacing="1" border="0" width="100%" align=center>
				<tr class="border">
					<td class="td_title" colspan="5">
						<center>
							<s:text name="addBlackInfoJsp.title"></s:text>
					...
					<td>
						<select name="valueType" class="select">
							<s:generator separator="," val="%{getText('blackInfo.valueType_value')}">
								<s:iterator var="str">
									<option value="${str}" <s:if test="valueType == #str">selected=selected</s:if>>
					...
					<td>
						<select name="blackType" class="select">
							<s:generator separator="," val="%{getText('blackInfo.blackType_value')}">
								<s:iterator var="str">
									<option value="${str}" <s:if test="blackType == #str">selected=selected</s:if>>
