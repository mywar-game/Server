...
/**
 * UserTreasureLog entity. @author MyEclipse Persistence Tools
 */

public class UserTreasureLog implements java.io.Serializable {
	...
	/** default constructor */
	public UserTreasureLog() {
	}

	/** minimal constructor */
	public UserTreasureLog(String userId, Integer treasureId,
