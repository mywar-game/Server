...
/**
 * UserMallLog entity. @author MyEclipse Persistence Tools
 */

public class UserMallLog implements java.io.Serializable {
	...
	/** full constructor */
	public UserMallLog(String userId, Integer userLevel, Integer treasureId,
