...
/**
 * UserEquipmentLogBak entity. @author MyEclipse Persistence Tools
 */

public class UserEquipmentLogBak implements java.io.Serializable {
	...
	/** default constructor */
	public UserEquipmentLogBak() {
	}

	/** full constructor */
	public UserEquipmentLogBak(Integer userEquipmentLogId,String userId, String userEquipmentId,
