...
public class UpdateAActionConstant extends ALDAdminActionSupport implements ModelDriven<AActionConstant> {

	private static final long serialVersionUID = 3522399526643243690L;
	...
	public String execute() {
		...
		actionConstantService.updateOneAActionConstant(actionConstant);
		return SUCCESS;
	}
