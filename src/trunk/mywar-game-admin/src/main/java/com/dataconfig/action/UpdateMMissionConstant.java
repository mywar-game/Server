 ...
 * 2012-7-21
 */
public class UpdateMMissionConstant extends ALDAdminActionSupport implements ModelDriven<MMissionConstant> {

	/**  */
	private static final long serialVersionUID = -5203476029141681802L;
	...
	public String execute() {
		...
		if ("F".equals(this.isCommit)) {
			...
			mmissionConstant = mMissionConstantService.findOneMMissionConstant(mmissionConstant.getMissionId());
//			System.out.println(mmissionConstant.getMissionId());
			...
			mMissionConstantService.updateOneMMissionConstant(mmissionConstant);
			return SUCCESS;
		}
	}
