...
/**
 * UserRemainByIpStats entity.
 */

public class UserRemainByIpStats implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 2849840509785903500L;
	private Integer id;
	...
	public UserRemainByIpStats(Integer id, Integer sysNum, Integer userTotal,
			Integer newReg, Integer dayActive, Float oneDayRemain,
			Float twoDayRemain, Float threeDayRemain, Float fourDayRemain,
			Float fiveDayRemain, Float sixDayRemain, Float sevenDayRemain,
			Float eightDayRemain, Float neightDayRemain, Float tenDayRemain,
			Float elevenDayRemain, Float twelfDayRemain,
			Float thirteenDayRemain, Float fourteenDayRemain,
			Float fifteenDayRemain, Float sixteenDayRemain,
			Float seventeenDayRemain, Float eightteenDayRemain,
			Float neightteenDayRemain, Float twentieDayRemain,
			Float twentieoneDayRemain, Float twentietwoDayRemain,
			Float twentiethreeDayRemain, Float twentiefourDayRemain,
			Float twentiefiveDayRemain, Float twentiesixDayRemain,
			Float twentiesevenDayRemain, Float twentieeightDayRemain,
			Float twentienightDayRemain, Float thirtyDayRemain, Date time,
			Integer oneDayRemainNum, Integer oneDayRegNum,
			Integer twoDayRemainNum, Integer twoDayRegNum,
			Integer threeDayRemainNum, Integer threeDayRegNum,
			Integer fourDayRemainNum, Integer fourDayRegNum,
			Integer fiveDayRemainNum, Integer fiveDayRegNum,
			Integer sixDayRemainNum, Integer sixDayRegNum,
			Integer sevenDayRemainNum, Integer sevenDayRegNum,
			Integer eightDayRemainNum, Integer eightDayRegNum,
			Integer neightDayRemainNum, Integer neightDayRegNum,
			Integer tenDayRemainNum, Integer tenDayRegNum,
			Integer elevenDayRemainNum, Integer elevenDayRegNum,
			Integer twelfDayRemainNum, Integer twelfDayRegNum,
			Integer thirteenDayRemainNum, Integer thirteenDayRegNum,
			Integer fourteenDayRemainNum, Integer fourteenDayRegNum,
			Integer fifteenDayRemainNum, Integer fifteenDayRegNum,
			Integer sixteenDayRemainNum, Integer sixteenDayRegNum,
			Integer seventeenDayRemainNum, Integer seventeenDayRegNum,
			Integer eightteenDayRemainNum, Integer eightteenDayRegNum,
			Integer neightteenDayRemainNum, Integer neightteenDayRegNum,
			Integer twentieDayRemainNum, Integer twentieDayRegNum,
			Integer twentieoneDayRemainNum, Integer twentieoneDayRegNum,
			Integer twentietwoDayRemainNum, Integer twentietwoDayRegNum,
			Integer twentiethreeDayRemainNum, Integer twentiethreeDayRegNum,
			Integer twentiefourDayRemainNum, Integer twentiefourDayRegNum,
			Integer twentiefiveDayRemainNum, Integer twentiefiveDayRegNum,
			Integer twentiesixDayRemainNum, Integer twentiesixDayRegNum,
			Integer twentiesevenDayRemainNum, Integer twentiesevenDayRegNum,
			Integer twentieeightDayRemainNum, Integer twentieeightDayRegNum,
			Integer twentieneightDayRemainNum, Integer twentieneightDayRegNum,
			Integer thirtyDayRemainNum, Integer thirtyDayRegNum,
			Integer newCreated) {
		super();
		this.id = id;
		this.sysNum = sysNum;
	...
	public UserRemainByIpStats(Integer id, Integer sysNum, Integer userTotal,
			...
			Float twoDayRemain, Float threeDayRemain, Float fourDayRemain,
			Float fiveDayRemain, Float sixDayRemain, Float sevenDayRemain,
			Float fifteenDayRemain, Float thirtyDayRemain, Date time,
			Integer oneDayRemainNum, Integer oneDayRegNum,
			Integer twoDayRemainNum, Integer twoDayRegNum,
			Integer threeDayRemainNum, Integer threeDayRegNum,
			Integer fourDayRemainNum, Integer fourDayRegNum,
	...
	/** default constructor */
	public UserRemainByIpStats() {
	}

	/** minimal constructor */
	public UserRemainByIpStats(Integer sysNum, Integer userTotal, Integer newReg,
			Integer dayActive) {
		this.sysNum = sysNum;
		this.userTotal = userTotal;
		this.newReg = newReg;
	...
	/** full constructor */
	public UserRemainByIpStats(Integer sysNum, Integer userTotal, Integer newReg,
			Integer dayActive, Float oneDayRemain, Float twoDayRemain,
			Float threeDayRemain, Float fourDayRemain, Float fiveDayRemain,
			Float sixDayRemain, Float sevenDayRemain, Float fifteenDayRemain,
			Float thirtyDayRemain, Date time) {
		this.sysNum = sysNum;
		this.userTotal = userTotal;
		this.newReg = newReg;
		this.dayActive = dayActive;
