...
/**
 * UserRemainByIdfaStats entity.
 */

public class UserRemainByIdfaStats implements java.io.Serializable {
	...
	public UserRemainByIdfaStats(Integer id, Integer sysNum, Integer userTotal,
	...
	/** default constructor */
	public UserRemainByIdfaStats() {
	}

	/** minimal constructor */
	public UserRemainByIdfaStats(Integer sysNum, Integer userTotal, Integer newReg,
			Integer dayActive) {
		this.sysNum = sysNum;
		this.userTotal = userTotal;
		this.newReg = newReg;
