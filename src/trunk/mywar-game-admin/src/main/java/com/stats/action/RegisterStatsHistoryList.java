...
public class RegisterStatsHistoryList extends ALDAdminStatsDatePageActionSupport {
	...
	public String execute() {
		if(isCommit.equals("T")){
			...
			Map<String, Object[]> map = registerStatsService.findRegisterDataHistory(dates);//历史各渠道的注册信息
			if(map.size()>0){
