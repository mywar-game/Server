...
public class UserVipTotalStats implements java.io.Serializable {
	...
	/** default constructor */
	public UserVipTotalStats() {
	}

	/** full constructor */
	public UserVipTotalStats(Integer sysNum, String partnerId, String vipInfo,
			Date time) {
		this.sysNum = sysNum;
