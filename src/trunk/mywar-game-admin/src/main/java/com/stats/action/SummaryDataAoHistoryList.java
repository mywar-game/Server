...
public class SummaryDataAoHistoryList extends ALDAdminStatsDatePageActionSupport {
	...
	public String execute() {
		...
		if(isCommit.equals("T")){
			...
			Map<String,Object[]> payMap = summaryStatsService.aoFindSummaryDataHistory(dates,channel+"");//联运充值总数、购买道具消耗
			Map<String, Object[]> onlineMap = onlineDetailStatsService.aoFindOnlineData(dates,channel+"");
