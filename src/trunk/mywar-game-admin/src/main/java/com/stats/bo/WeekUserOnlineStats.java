...
/**
 * WeekUserOnlineStats entity. @author MyEclipse Persistence Tools
 */

public class WeekUserOnlineStats implements java.io.Serializable {
	...
	/** default constructor */
	public WeekUserOnlineStats() {
	}

	/** minimal constructor */
	public WeekUserOnlineStats(Integer sysNum, Date date,
	...
	/** full constructor */
	public WeekUserOnlineStats(Integer sysNum, Date date, Integer onlineAmount,
