 ...
 * @author yezp
 */
public class UpdateConfigs extends ALDAdminActionSupport {

	private static final long serialVersionUID = -1689611980975043420L;

	private static final String REQ_URL = "/webApi/updateConfigs.do";
	...
	public String execute() {
		...
		adminChangeConstantLog.setChangeTime(new Timestamp(System
				.currentTimeMillis()));
		adminChangeConstantLog.setConstantName("UpdateConfigs");
		adminChangeConstantLog.setChangeType(1);
		adminChangeConstantLog.setChangeDetail("修改日志");
